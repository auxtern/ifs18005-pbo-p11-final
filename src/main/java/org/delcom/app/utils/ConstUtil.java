...
public class ConstUtil {
    ...
    public static final String TEMPLATE_PAGES_CASH_FLOWS_DETAIL = "pages/cash-flows/detail";
    public static final String TEMPLATE_PAGES_CASH_FLOWS_STATS = "pages/cash-flows/stats";
}
